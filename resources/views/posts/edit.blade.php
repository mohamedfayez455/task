                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"> Edit Post Page</h3>
                        </div>
                        <!-- /.card-header -->
                        ...
                        <form  role="form" method="post" action="{{route('posts.update' , $post->id)}}" >
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12 ">
                                                    ...
                                                    <input type="text" id="name" name="name" class="form-control"  value="{{ $post->name }}"   placeholder="Enter Name">
                                                </div>
                            ...
                            <div class="card-footer">
                                <button type="submit" id="submit-all" class="btn btn-primary"> Edit Post</button>
                            </div>
